...
public class UpdateClient extends javax.swing.JDialog {
    ...
    public void setClient(Client client){
        this.client=client;
        txfName.setText(client.getName());
        txfAgo.setText(client.getAgo()+"");
        txfPhone.setText(client.getPhone());
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        if(!(nameEmpty.length()==0 || txfAgo.getText().length()==0 || phoneEmpty.length()==0 || cityEmpty.length()==0)){
            ...
            if(ClientModel.Update(client.getId(),name, ago, phone, city)){
                dispose();
            }else{
                JOptionPane.showMessageDialog(this, "No se ha podido editar al usuario");
            }
        }else{
